class SearchingController < ApplicationController
  ...
  def show
    @client_workout = Sofa.find(params[:id])
  ...
  def create
    @client_workout = Sofa.new(params[:client_workout])
  ...
  def find
    ...
    @client_workout = Sofa.find(:all,
      :conditions=>["title = ?", params[:search_string]])
  end
end
